...
julia --project=. scripts/julia/fit_matfac.jl simulated_data.hdf data/msigdb/hallmark-pwys.json simulated_params_fit.bson simulated_data_transformed.hdf K=5 use_batch=true omic_types=mrnaseq:methylation:cna:mutation var_filter=1.0 fsard_A_prior_frac=1.0 fsard_frac_atol=0.05 configuration=fsard max_epochs=10000 lr_theta=1.02 lr_regress=1.01 lr=1.0  
