...
##julia --project=. scripts/julia/simulate_matfac.jl temp/real_data_runs/omic_data/heldout_ctypes\=OV\:GBM\:LAML__kept_ctypes\=HNSC.hdf data/msigdb/hallmark-pwys.json simulated_params.bson simulated_data.hdf K=5 use_batch=true omic_types=mrnaseq:methylation:cna:mutation var_filter=0.01 configuration=fsard A_density=0.1 missingness=0.125
julia --project=. scripts/julia/simulate_matfac.jl temp/real_data_runs/omic_data/heldout_ctypes\=OV\:GBM\:LAML__kept_ctypes\=HNSC.hdf data/msigdb/hallmark-pwys.json simulated_params.bson simulated_data.hdf K=5 use_batch=false omic_types=mrnaseq:methylation:cna:mutation var_filter=0.01 configuration=ard missingness=0.125
...
#julia --threads 4 --project=. scripts/julia/fit_matfac.jl simulated_data.hdf data/msigdb/hallmark-pwys.json simulated_params_fit.bson simulated_data_transformed.hdf K=10 use_batch=true omic_types=mrnaseq:methylation:cna:mutation var_filter=1.0 fsard_A_prior_frac=0.05 fsard_frac_atol=0.025 configuration=fsard max_epochs=10000 lr_theta=1.0 lr_regress=1.0 lr=1.0  

julia --threads 4 --project=. scripts/julia/fit_matfac.jl simulated_data.hdf data/msigdb/hallmark-pwys.json simulated_params_fit.bson simulated_data_transformed.hdf K=5 use_batch=false omic_types=mrnaseq:methylation:cna:mutation var_filter=1.0 configuration=ard max_epochs=3000 lr_theta=1.0 lr_regress=1.0 lr=1.0 #fit_reg_weight=EB #lambda_X_l2=0.0 lambda_X_condition=0.0 lambda_Y_l2=0.0 fit_reg_weight=nothing 
