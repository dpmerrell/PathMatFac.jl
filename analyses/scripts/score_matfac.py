...
def score_Y(true_Y, fitted_Y):
    ...
    scores["combined_av_prec"] = combined_av_prec
    ...
    scores["mean_av_prec"] = mean_av_prec

    return scores


def score_X(true_X, fitted_X):
...
def compute_scores(true_hdf, fitted_hdf):
    ...
    X_scores = score_X(true_X, fitted_X)
