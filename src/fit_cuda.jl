...
function fit_line_search!(model::MatFacModel, A::AbstractMatrix;
    ...
    function grad_fn_x(X_)
        ...
        XY_d .*= obs_mask
        XY_d .+= missing_mask
        compute_grad_X!(grad_X, X_, Y_d_gradx_view, XY_d, 
                        XY_ql_view, XY_ll_view, XY_pl_view,
                        A_ql_view, A_ll_view, A_pl_view,
                        feature_scales,
                        inst_reg_mats_d)
    ...
    function grad_fn_y(Y_)
        ...
        XY_d .*= obs_mask
        XY_d .+= missing_mask
        compute_grad_Y!(grad_Y, X_d_grady_view, Y_, XY_d, 
                        XY_ql_view, XY_ll_view, XY_pl_view,
                        A_ql_view, A_ll_view, A_pl_view,
                        feature_scales,
                        feat_reg_mats_d)
    ...
    function loss_fn_x(X_)
        return compute_loss!(X_, Y_d, XY_ql_view, XY_ll_view, XY_pl_view,
                             A_ql_view, A_ll_view, A_pl_view,
                             inst_reg_mats_d, feat_reg_mats_d)
    end

    function loss_fn_y(Y_)
        return compute_loss!(X_d, Y_, XY_ql_view, XY_ll_view, XY_pl_view,
                             A_ql_view, A_ll_view, A_pl_view,
                             inst_reg_mats_d, feat_reg_mats_d)
    end
